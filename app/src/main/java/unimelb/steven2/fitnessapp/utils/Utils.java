package unimelb.steven2.fitnessapp.utils;
...
public class Utils {
    ...
    public static float getRate(Date dEnd, Date dIni) {
        long diffInMs = dEnd.getTime() - dIni.getTime();

        //float diffInSec = TimeUnit.MILLISECONDS.toSeconds(diffInMs);
        float diffInSec = (float) (diffInMs/1000.0);
